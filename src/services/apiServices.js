...
const postCreateNewUser = (email,password,username,role,image)=>{ //có image → cần FormData Content-Type: multipart/form-data
    const data = new FormData(); //dùng 
...
const putUpdateUser = (id,username,role,image)=>{ //có image → cần FormData Content-Type: multipart/form-data
